...
func _ready():
	connect("settings_loaded", self, "_on_settings_loaded")
...
func load_settings():
	...
	if error:
		...
		load_from_config("display", "fullscreen")
...
func load_from_config(section, key):
...
func _on_settings_loaded():
	...
	$"/root/main_menu/settings_menu/tab_container/DISPLAY/fullscreen".set_pressed(fullscreen)
